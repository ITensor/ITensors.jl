...
module TestITensorDMRG
  ...
  cpu_2_1e3_0_elt = Dict([(Float32, Float32(-2)), (ComplexF32, Float32(-2)), (Float64, Float64(-2)), (ComplexF64, Float64(-2))])
  cpu_2_1e3_1e12_elt =Dict([(Float32, Float32(-2)), (ComplexF32, Float32(-2)), (Float64, Float64(-2)), (ComplexF64, Float64(-2))])
  cpu_2_1e13_0_elt = Dict([(Float32, Float32(-2)), (ComplexF32, Float32(-2)), (Float64, Float64(-2)), (ComplexF64, Float64(-2))])
  cpu_2_1e13_1e12_elt = Dict([(Float32, Float32(-2)), (ComplexF32, Float32(-2)), (Float64, Float64(-2)), (ComplexF64, Float64(-2))])
  cpu_8_1e3_0_elt = Dict([(Float32,  -10.073674), (ComplexF32, -10.075782), (Float64, -10.075497754329614), (ComplexF64, -10.074342093827271)])
  cpu_8_1e3_1e12_elt = Dict([(Float32, -10.0757885), (ComplexF32, -10.075473), (Float64, -10.073420413855567), (ComplexF64, -10.07548425264575)])
  cpu_8_1e13_0_elt = Dict([(Float32, -10.124351), (ComplexF32, -10.124425), (Float64, -10.124596033315136), (ComplexF64, -10.124530685719115)])
  cpu_8_1e13_1e12_elt = Dict([(Float32, -10.124598), (ComplexF32, -10.1246), (Float64, -10.124610860111224), (ComplexF64, -10.124628100679796)])
