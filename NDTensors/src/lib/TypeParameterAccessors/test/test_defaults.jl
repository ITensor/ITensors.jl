...
@testset "TypeParameterAccessors defaults" begin
  ...
  @testset "Set defaults" begin
    ...
    @test_inferred set_default_parameter(Array{Float32}, eltype) == Array{Float64}
    @test_inferred set_default_parameters(Array{Float32}) == Vector{Float64}
    @test_inferred set_default_parameters(Array{Float32}, (1, 2)) == Vector{Float64} wrapped =
      true
    @test_inferred set_default_parameters(Array{Float32}, (Position(1), Position(2))) ==
      Vector{Float64}
    @test_inferred set_default_parameters(Array{Float32}, (eltype, ndims)) ==
      Vector{Float64}
    @test_inferred set_default_parameters(Array) == Vector{Float64} wrapped = true
    @test_inferred set_default_parameters(Array, (Position(1),)) == Array{Float64}
    @test_inferred set_default_parameters(Array, (Position(1), Position(2))) ==
      Vector{Float64}
  end
  @testset "Specify defaults" begin
    ...
    @test_inferred specify_default_parameter(Array, Position(2)) == Vector
    @test_inferred specify_default_parameter(Array, ndims) == Vector
    @test_inferred specify_default_parameters(Array) == Vector{Float64}
    @test_inferred specify_default_parameters(Array, (1,)) == Array{Float64} wrapped = true
    @test_inferred specify_default_parameters(Array, (Position(1),)) == Array{Float64}
    @test_inferred specify_default_parameters(Array, (eltype,)) == Array{Float64}
    @test_inferred specify_default_parameters(Array, (2,)) == Vector wrapped = true
    @test_inferred specify_default_parameters(Array, (Position(2),)) == Vector
    @test_inferred specify_default_parameters(Array, (ndims,)) == Vector
    @test_inferred specify_default_parameters(Array, (1, 2)) == Vector{Float64} wrapped =
      true
    @test_inferred specify_default_parameters(Array, (Position(1), Position(2))) ==
      Vector{Float64}
    @test_inferred specify_default_parameters(Array, (eltype, ndims)) == Vector{Float64}
  end
