...
const PermutedDimsBlockSparseArray{T,N,P,IP} = PermutedDimsArray{T,N,P,IP,<:AbstractBlockSparseArray{T,N}}

function BlockArrays.blocks(a::PermutedDimsBlockSparseArray)
  return blocksparse_blocks(a)
end

function Base.similar(a::PermutedDimsBlockSparseArray, elt::Type, axes::Tuple{Vararg{BlockedUnitRange}})
  # TODO: Preserve GPU!
