using NDTensors.TypeParameterAccessor: TypeParameterAccessor, Position
...
function TypeParameterAccessor.get_parameter(
...
# ## Setting paramaters
function TypeParameterAccessor.set_parameter(
...
# ## default parameters
function TypeParameterAccessor.default_parameter(::Type{<:UnallocatedArray}, ::Position{4})
  return UnspecifiedArray{UnspecifiedNumber{UnspecifiedZero},0}
end

TypeParameterAccessor.nparameters(::Type{<:UnallocatedArray}) = Val(4)
