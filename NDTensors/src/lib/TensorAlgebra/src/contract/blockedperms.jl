...
function blockedperms(::typeof(contract), dimnames_dest, dimnames1, dimnames2)
  codomain = setdiff(dimnames1, dimnames2)
  contracted = intersect(dimnames1, dimnames2)
  domain = setdiff(dimnames2, dimnames1)
  ...
  biperm_dest = blockedperm((perm_codomain_dest, perm_domain_dest), length(dimnames_dest))
  biperm1 = blockedperm((perm_codomain1, perm_domain1), length(dimnames1))
  biperm2 = blockedperm((perm_codomain2, perm_domain2), length(dimnames2))
