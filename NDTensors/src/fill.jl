...
function generic_randn(StoreT::Type{<:Dense{ElT, DataT}}, 
      dim::Integer=0) where {DataT<:AbstractArray{ElT}} where {ElT}
...
function generic_zeros(StoreT::Type{<:Dense{ElT, DataT}}, 
  dim::Integer=0) where {DataT<:AbstractArray{ElT}} where {ElT}
