...
set_eltype_if_unspecified(arraytype::Type{<:AbstractArray{T, N}}, eltype::Type{<:Number} = default_eltype()) where {T, N} = arraytype
set_eltype_if_unspecified(arraytype::Type{<:AbstractArray}, eltype::Type{<:Number} = default_eltype()) = similartype(arraytype, eltype)
