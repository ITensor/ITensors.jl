...
function set_eltype_if_unspecified(arraytype::Type{<:CuArray}, eltype::Type= NDTensors.default_eltype())
...
function set_buffertype_if_unspecified(arraytype::Type{<:CuArray{<:Any, <:Any, <:Any}}, ::Type = default_buffertype())
  return arraytype
end

function set_buffertype_if_unspecified(arraytype::Type{<:CuArray{<:Any, <:Any}}, buf::Type=default_buffertype())
