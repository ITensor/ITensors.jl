...
function _precompile_()
    ...
    precompile(Tuple{Core.kwftype(typeof(ITensors.NDTensors.eigen)),NamedTuple{(:ishermitian, :which_decomp, :tags, :maxdim, :mindim, :cutoff, :eigen_perturbation, :ortho),Tuple{Bool,Nothing,TagSet,Int64,Int64,Float64,Nothing,String}},typeof(eigen),LinearAlgebra.Hermitian{Float64,ITensors.NDTensors.Tensor{Float64,2,ITensors.NDTensors.Dense{Float64,Array{Float64,1}},IndexSet{2,Index{Int64}}}}})
    precompile(Tuple{Core.kwftype(typeof(ITensors.NDTensors.svd)),NamedTuple{(:alg,),Tuple{String}},typeof(svd),ITensors.NDTensors.Tensor{Complex{Float64},2,ITensors.NDTensors.Dense{Complex{Float64},Array{Complex{Float64},1}},IndexSet{2,Index{Int64}}}})
    precompile(Tuple{Core.kwftype(typeof(ITensors.NDTensors.svd)),NamedTuple{(:alg,),Tuple{String}},typeof(svd),ITensors.NDTensors.Tensor{Float64,2,ITensors.NDTensors.Dense{Float64,Array{Float64,1}},IndexSet{2,Index{Int64}}}})
    precompile(Tuple{Core.kwftype(typeof(ITensors.factorize)),NamedTuple{(:which_decomp, :tags, :maxdim, :mindim, :cutoff, :eigen_perturbation, :ortho),Tuple{Nothing,TagSet,Int64,Int64,Float64,Nothing,String}},typeof(factorize),ITensor{3},IndexSet{2,Index{Int64}}})
    precompile(Tuple{Core.kwftype(typeof(ITensors.replacebond!)),NamedTuple{(:maxdim, :mindim, :cutoff, :eigen_perturbation, :ortho, :which_decomp),Tuple{Int64,Int64,Float64,Nothing,String,Nothing}},typeof(replacebond!),MPS,Int64,ITensor{3}})
    ...
    precompile(Tuple{typeof(==),IndexSet{4,Index{Int64}},IndexSet{4,Index{Int64}}})
    ...
    precompile(Tuple{typeof(Base.vect),ITensor{3}})
    ...
    precompile(Tuple{typeof(ITensors.setstore!),ITensor{3},ITensors.NDTensors.Dense{Float64,Array{Float64,1}}})
    ...
    precompile(Tuple{typeof(addtags),TagSet,String})
    ...
    precompile(Tuple{typeof(dag),ITensor{2}})
    ...
    precompile(Tuple{typeof(mul!),ITensor{3},KrylovKit.OrthonormalBasis{ITensor{3}},SubArray{Float64,1,Array{Float64,2},Tuple{UnitRange{Int64},Int64},true}})
    ...
    precompile(Tuple{typeof(replaceinds),IndexSet{3,Index{Int64}},IndexSet{1,Index{Int64}},IndexSet{1,Index{Int64}}})
