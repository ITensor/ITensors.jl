...
function _precompile_()
    ...
    precompile(Tuple{typeof(dag),IndexSet{3,Index{Int64}}})
    ...
    precompile(Tuple{typeof(noprime),IndexSet{3,Index{Int64}}})
    ...
    precompile(Tuple{typeof(randomITensor),Type{Complex{Float64}},Index{Int64},Index{Int64}})
