...
function contract!!(R::Tensor{<:Number,NR},
  ...
  @show labelsT1
  @show labelsT2
  @show count_unique(labelsT1,labelsT2)
  @show count_common(labelsT1,labelsT2)
