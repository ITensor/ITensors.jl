...
function _precompile_()
    ...
    let fbody = try __lookup_kwbody__(which(ITensors.settags!, (ITensor{2},TagSet,Vararg{Any,N} where N,))) catch missing end
        if !ismissing(fbody)
            precompile(fbody, (Base.Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}},typeof(settags!),ITensor{2},TagSet,Vararg{Any,N} where N,))
        end
    end
    ...
    precompile(Tuple{Core.kwftype(typeof(ITensors.eigen)),NamedTuple{(:ishermitian, :which_decomp, :tags, :maxdim, :mindim, :cutoff, :eigen_perturbation, :ortho),Tuple{Bool,String,TagSet,Int64,Int64,Float64,Nothing,String}},typeof(eigen),ITensor{2},IndexSet{1,Index{Int64}},IndexSet{1,Index{Int64}}})
    ...
    precompile(Tuple{typeof(*),ITensor{2},ITensor{2}})
    ...
    precompile(Tuple{typeof(Base.Broadcast.materialize!),AutoMPO,Base.Broadcast.Broadcasted{ITensors.AutoMPOAddTermStyle,Nothing,typeof(+),Tuple{AutoMPO,Tuple{String,Int64,String,Int64}}}})
    ...
    precompile(Tuple{typeof(ITensors.compute_contraction_labels),IndexSet{4,Index{Int64}},IndexSet{1,Index{Int64}}})
    ...
    precompile(Tuple{typeof(copy),Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple},Nothing,typeof(ITensors.itensor2inds),Tuple{Tuple{ITensor{2},ITensor{3}}}}})
    ...
    precompile(Tuple{typeof(hassameinds),IndexSet{1,Index{Int64}},IndexSet{1,Index{Int64}}})
    ...
    precompile(Tuple{typeof(norm),ITensors.NDTensors.Tensor{Float64,3,ITensors.NDTensors.Dense{Float64,Array{Float64,1}},IndexSet{3,Index{Int64}}}})
    ...
    precompile(Tuple{typeof(randomITensor),Index{Int64},Index{Int64}})
    ...
    precompile(Tuple{typeof(settags),IndexSet{2,Index{Int64}},TagSet,Index{Int64}})
    ...
    precompile(Tuple{typeof(svd),ITensor{2},Index{Int64}})
end
