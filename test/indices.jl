...
@testset "Allow general mixtures of collections of QN indices" begin
  ...
  @test hassameinds(ITensor(undef, QN(), is1...), is)
  @test hassameinds(emptyITensor(QN(), is1), is)
  @test hassameinds(emptyITensor(QN(), is2), is)
  @test hassameinds(emptyITensor(QN(), is1...), is)
  @test hassameinds(emptyITensor(Float64, QN(), is1), is)
  @test hassameinds(emptyITensor(Float64, QN(), is2), is)
  @test hassameinds(emptyITensor(Float64, QN(), is1...), is)
end
