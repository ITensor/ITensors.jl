...
@testset "Allow general mixtures of collections of indices" begin
    ...
    @test hassameinds(ITensor(Float64, is1...), is)
    @test hassameinds(random_itensor(is1), is)
    @test hassameinds(random_itensor(is2), is)
    @test hassameinds(random_itensor(is1...), is)
    @test hassameinds(random_itensor(Float64, is1), is)
    @test hassameinds(random_itensor(Float64, is2), is)
    @test hassameinds(random_itensor(Float64, is1...), is)
    ...
    @test hassameinds(itensor(Float64, A, is2), is)
    @test hassameinds(itensor(Float64, A, is1...), is)
    @test hassameinds(diag_itensor(is1), is)
    @test hassameinds(diag_itensor(is2), is)
    @test hassameinds(diag_itensor(is1...), is)
    @test hassameinds(diag_itensor(Float64, is1), is)
    @test hassameinds(diag_itensor(Float64, is2), is)
    @test hassameinds(diag_itensor(Float64, is1...), is)
    @test hassameinds(diag_itensor(D, is1), is)
    @test hassameinds(diag_itensor(D, is2), is)
    @test hassameinds(diag_itensor(D, is1...), is)
    @test hassameinds(diag_itensor(Float64, D, is1), is)
    @test hassameinds(diag_itensor(Float64, D, is2), is)
    @test hassameinds(diag_itensor(Float64, D, is1...), is)
    @test hassameinds(diag_itensor(x, is1), is)
    @test hassameinds(diag_itensor(x, is2), is)
    @test hassameinds(diag_itensor(x, is1...), is)
    @test hassameinds(diag_itensor(Float64, x, is1), is)
    @test hassameinds(diag_itensor(Float64, x, is2), is)
    @test hassameinds(diag_itensor(Float64, x, is1...), is)
...
@testset "Allow general mixtures of collections of QN indices" begin
    ...
    @test hassameinds(ITensor(Float64, QN(), is1...), is)
    @test hassameinds(random_itensor(QN(), is1), is)
    @test hassameinds(random_itensor(QN(), is2), is)
    @test hassameinds(random_itensor(QN(), is1...), is)
    @test hassameinds(random_itensor(Float64, QN(), is1), is)
    @test hassameinds(random_itensor(Float64, QN(), is2), is)
    @test hassameinds(random_itensor(Float64, QN(), is1...), is)
